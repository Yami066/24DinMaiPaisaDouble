...
All your configurations will be in a file in the root directory, called `config.json`, which is a copy of `config.example.json`.This document explains every configuration key inside `config.json` for 24DinMaiPaisaDouble.
...
- **Type**: `String`
- **Description**: Your Google Gemini API key. Used as a fallback for LLM text generation and for image synthesis.
- **Get it here**: [Google AI Studio](https://aistudio.google.com/app/apikey)

#### `gemini_image_model`
- **Type**: `String`
- **Default**: `"imagen-3.0-generate-002"`
- **Description**: The specific Gemini model used for image generation.
...
```json
{
  ...
  "gemini_image_api_base_url": "https://generativelanguage.googleapis.com/v1beta",
  "gemini_image_api_key": "",
...
- `GEMINI_API_KEY`: used when `gemini_image_api_key` is empty.
